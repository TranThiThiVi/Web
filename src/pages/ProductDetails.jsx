          ...
          <Row>
            ...
            <Col lg='6'>
              <div className="product_details">
                ...
                {/* <motion.button  whileTap={{scale:1.2}}  className="buy_btn' "> Buy Now</motion.button>  */}
              </div>
            </Col>
          </Row>
        </Container>
                    ...
                    <div className="review_wrapper">
                      ...
                      <div className="review_form">
                        ...
                        <form action="" onSubmit={submitHandler} >
                          ...
                          <div className="form_group">
                            <textarea ref={reviewMsg} rows={4} type="text" placeholder="Review Maggess...."
                              required
                            />
